...
Map of config keys accepted by hl.get_config and represented in HL.ConfigValueTypes.
These are flat Hyprland config keys and their expected Lua value types.
