...
['decoration.shadow.offset'] : :class:`HL.Vec2Like`
...
['general.col.active_border'] : string | :class:`HL.Gradient`
   ['general.col.active border'].

['general.col.inactive_border'] : string | :class:`HL.Gradient`
   ['general.col.inactive border'].

['general.col.nogroup_border'] : string | :class:`HL.Gradient`
   ['general.col.nogroup border'].

['general.col.nogroup_border_active'] : string | :class:`HL.Gradient`
   ['general.col.nogroup border active'].

['general.extend_border_grab_area'] : integer | boolean
   ['general.extend border grab area'].

['general.float_gaps'] : integer | :class:`HL.CssGap`
   ['general.float gaps'].

['general.gaps_in'] : integer | :class:`HL.CssGap`
   ['general.gaps in'].

['general.gaps_out'] : integer | :class:`HL.CssGap`
   ['general.gaps out'].
...
['group.col.border_active'] : string | :class:`HL.Gradient`
   ['group.col.border active'].

['group.col.border_inactive'] : string | :class:`HL.Gradient`
   ['group.col.border inactive'].

['group.col.border_locked_active'] : string | :class:`HL.Gradient`
   ['group.col.border locked active'].

['group.col.border_locked_inactive'] : string | :class:`HL.Gradient`
...
['group.groupbar.col.active'] : string | :class:`HL.Gradient`
   ['group.groupbar.col.active'].

['group.groupbar.col.inactive'] : string | :class:`HL.Gradient`
   ['group.groupbar.col.inactive'].

['group.groupbar.col.locked_active'] : string | :class:`HL.Gradient`
   ['group.groupbar.col.locked active'].

['group.groupbar.col.locked_inactive'] : string | :class:`HL.Gradient`
...
['input.tablet.active_area_position'] : :class:`HL.Vec2Like`
   ['input.tablet.active area position'].

['input.tablet.active_area_size'] : :class:`HL.Vec2Like`
...
['input.tablet.region_position'] : :class:`HL.Vec2Like`
   ['input.tablet.region position'].

['input.tablet.region_size'] : :class:`HL.Vec2Like`
...
['layout.single_window_aspect_ratio'] : :class:`HL.Vec2Like`
